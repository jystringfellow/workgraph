...
This field is for high-noise project internals that commonly appear under watched roots, such as `.git`, `node_modules`, Xcode `DerivedData`, and Apple `.noindex` directories.
